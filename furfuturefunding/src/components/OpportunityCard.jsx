 ...
 const scholarshipData = [
   {
     ...
     description: "A scholarship opportunity for students pursuing advanced studies in science and technology.",
   ...
   },
   {
     ...
     description: "Supporting Indigenous students in pursuing higher education across all fields.",
   ...
   },
   {
     ...
     description: "Scholarship for outstanding students in engineering disciplines.",
        ...
        <div className="card" key={index}>
         <div className="header-section">
           <div className="image-container">
             <img src={scholarship.image} alt={scholarship.title} className="card-image" />
           </div>
         ...
         <div className="card-content">
           ...
           <div className="details">
             <div className="info-row">
               ...
               <span>Opens: {new Date(scholarship.opening_date).toLocaleDateString()}</span>
             </div>

             <div className="info-row">
               <span className="material-icons">calendar_today</span>
               <span>Closes: {new Date(scholarship.closing_date).toLocaleDateString()}</span>
             </div>
